...
const char* ANCHOR_ID   = "anchor2";       // Change: anchor1 / anchor2 / anchor3
const double ANCHOR_LAT = 27.6193143;       // Set real lat of this anchor
const double ANCHOR_LON = 85.5371505;       // Set real lon of this anchor
// 
...
const float RSSI_REF      = -62.5;  // Measured avg RSSI at 1m
